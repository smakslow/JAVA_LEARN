...
public class FileRename {
    ...
    static String oldString = "【灰灰考研】";//要被替换的字符串
    static String dir = "C:\\Users\\51484\\Desktop\\C++\\DS";//文件所在路径，所有文件的根目录，记得修改为你电脑上的文件所在路径
                ...
                for (File file : fileArr) {
                    if (file.isDirectory()) {//是文件夹，继续递归，如果需要重命名文件夹，这里可以做处理
                        ...
                        if (fileName.contains(oldString)) {//文件名包含需要被替换的字符串
                            ...
                            newDir = new File("C:\\Users\\51484\\Desktop\\C++\\DS" + "/" + newName);//文件所在文件夹路径+新文件名
